...
export default class StatisticsBlock extends React.Component<StatisticsBlockPropsType, {}> {
  ...
  public render() {
      return (
                        ...
                        <Text   style={[styles.stats, styles.value, {color: this.props.valueColor ? this.props.valueColor : "black"}]}>{this.props.value} 
                        <Text   style={[styles.stats, styles.unit, {color: this.props.valueColor ? this.props.valueColor : "black"}]}> {this.props.units}</Text></Text>
